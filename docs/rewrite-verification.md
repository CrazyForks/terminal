...
- Python worker tests cover browser-harness download-style artifacts, refreshed browser target identity across calls, and managed-browser selection that avoids system Chromium unless explicitly opted in.
