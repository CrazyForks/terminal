...
pub const MODEL_REASONING_START: &str = "model.reasoning.start";
pub const MODEL_REASONING_DELTA: &str = "model.reasoning.delta";
pub const MODEL_REASONING_END: &str = "model.reasoning.end";
