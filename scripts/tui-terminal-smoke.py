...
def smoke_double_escape_opens_message_selector(binary: Path) -> None:
    ...
    try:
        ...
        assert_contains(selector, "start", "message selector should show the submitted prompt")
        assert_contains(
            selector,
...
def smoke_escape_reclaims_prompt_before_output(binary: Path) -> None:
    ...
    try:
        ...
        assert_contains(reclaimed, f"> {prompt}", "escape should return submitted text to composer")
        assert_not_contains(
            reclaimed,
